                            ...
                            <ul class="list-inline float-right mb-0">
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    <a class="nav-link dropdown-toggle arrow-none waves-effect" data-toggle="dropdown" href="#" role="button"
                                       aria-haspopup="false" aria-expanded="false">
                                        ...
                                        <span class="badge badge-danger noti-icon-badge">6</span>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                                        <!-- item-->
                                        <div class="dropdown-item noti-title">
                                            <h5><span class="badge badge-danger float-right">6</span>Messages</h5>
                                        </div>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            ...
                                            <p class="notify-details"><b>Thomas J. Mimms</b><small class="text-muted">You have 9 unread messages</small></p>
                                        </a>
                                ...
                                <li class="list-inline-item dropdown notification-list">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                                        <!-- item-->
                                        <div class="dropdown-item noti-title">
                                            <h5><span class="badge badge-danger float-right">9</span>Notifikasi</h5>
                                        </div>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            ...
                                            <p class="notify-details"><b>New Message received</b><small class="text-muted">You have 9 unread messages</small></p>
                                        </a>
